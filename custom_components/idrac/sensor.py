...
async def async_setup_entry(
    ...
    category_sensors = [
        ...
        # ("power_supplies", IdracPowerSupplySensor), # Removed: Handled by binary_sensor.py as PSU Health
        # ("memory", IdracMemorySlotSensor), # Removed: Handled by binary_sensor.py as DIMM Socket Health
        # ("battery", IdracBatterySensor), # Removed: Handled by binary_sensor.py as Battery Health
