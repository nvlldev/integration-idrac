...
Usage: python tests/test_all_intrusion_oids.py (uses .env.local or .env.test)
...
if __name__ == "__main__":
    ...
    if not HOST:
        ...
        print("  1. Command line: python tests/test_all_intrusion_oids.py <host> [community] [port]")
        print("  2. Environment: Configure IDRAC_HOST in .env.local or .env.test")
        sys.exit(1)
    
    print(f"Comprehensive intrusion testing on {HOST}:{PORT} with community '{COMMUNITY}'")
